...
- **Тесты:** 232 client + 153 host + 84 exec-core + 88 protocol + 41 transport (BLE+factory+reconnect) + 22 term + 14 wiredesk-core = 634 passing (+5 ignored). Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

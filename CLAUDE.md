...
- **Тесты:** 231 client + 155 host + 83 exec-core + 84 protocol + 41 transport (BLE+factory+reconnect) + 22 term + 14 wiredesk-core = 625 passing (+5 ignored = 630 total). Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

...
- **Тесты:** 162 client + 97 host + 60 protocol + 22 term + 81 exec-core + 4 transport = 426. Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

...
- **Тесты:** 261 client + 148 host + 84 exec-core + 88 protocol + 51 transport (BLE+factory+reconnect+detect) + 37 term + 18 wiredesk-core = 687 passing (+5 ignored). Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

...
- **Тесты:** 261 client + 158 host + 84 exec-core + 88 protocol + 41 transport (BLE+factory+reconnect) + 23 term + 18 wiredesk-core = 673 passing (+5 ignored). Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

...
- **Тесты:** 162 client + 97 host + 60 protocol + 22 term + 72 exec-core + 4 transport = 417. Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

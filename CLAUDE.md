...
- **Тесты:** 173 client + 173 host + 84 protocol + 22 term + 60 exec-core + 41 transport (15 BLE + 6 reconnect + 6 factory + 14 prior) + 4 wiredesk-core = 557. Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

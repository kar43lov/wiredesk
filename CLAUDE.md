...
- **Тесты:** 172 client + 108 host + 84 exec-core + 60 protocol + 41 transport (BLE+factory+reconnect) + 22 term + 4 wiredesk-core = 491 passing (+3 ignored = 494 total). Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

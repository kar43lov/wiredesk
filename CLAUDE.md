...
- **Тесты:** 242 client + 157 host + 84 exec-core + 88 protocol + 41 transport (BLE+factory+reconnect) + 23 term + 18 wiredesk-core = 653 passing (+5 ignored). Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.

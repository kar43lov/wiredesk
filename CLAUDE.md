...
- **Тесты:** 162 client + 97 host + 60 protocol + 22 term + 82 exec-core + 4 transport = 427. Host-side flaky на parallel runner'е macOS — `cargo test --workspace -- --test-threads=1`.
